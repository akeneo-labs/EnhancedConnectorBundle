...
namespace Pim\Bundle\EnhancedConnectorBundle\Job\JobParameters\ConstraintCollectionProvider;
...
/**
 * Constraints for family CSV export
 *
 * @author    Philippe Mossière <philippe.mossiere@akeneo.com>
 * @copyright 2016 Akeneo SAS (http://www.akeneo.com)
 * @license   http://opensource.org/licenses/osl-3.0.php Open Software License (OSL 3.0)
 */
class FamilyCsvExport implements ConstraintCollectionProviderInterface
{
    ...
    public function getConstraintCollection()
    {
        ...
        $constraintFields['labelLocale'] = new NotBlank();
