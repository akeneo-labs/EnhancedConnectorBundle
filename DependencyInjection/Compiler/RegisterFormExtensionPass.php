...
namespace Pim\Bundle\EnhancedConnectorBundle\DependencyInjection\Compiler;
...
class RegisterFormExtensionPass implements CompilerPassInterface
{
    ...
    public function process(ContainerBuilder $container)
    {
        ...
        $attributeFields = [];
        $filepaths = [
            __DIR__ .'/../../Resources/config/form_extensions_ee/pimgento_csv_family_export_permissions.yml',
        ];
